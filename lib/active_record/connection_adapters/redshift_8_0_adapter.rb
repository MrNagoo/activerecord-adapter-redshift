...
module ActiveRecord
  ...
  module ConnectionAdapters
    ...
    class RedshiftAdapter < AbstractAdapter
      ...
      # Rails 8: clear_cache! now accepts new_connection parameter
      ...
      # Rails 8: Ensure string and primary_key types are properly mapped
      def type_to_sql(type, limit: nil, precision: nil, scale: nil, **)
        case type.to_s
        when 'string'
          type = :varchar
        when 'primary_key'
          return 'integer identity' unless limit
          type = :varchar
        end
        super
      end
